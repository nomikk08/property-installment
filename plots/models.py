...
class Plot(models.Model):
    ...
    plot_type = models.CharField(max_length=20, choices=PLOT_TYPE, default="residential")   # Commercial or Residential
    ...
    size_sqft = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)   # For "1500 SFT" etc.
    size_sq_yards = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
    ...
    # Extra
    is_corner = models.BooleanField(default=False)  # corner plots often have higher value
    facing_direction = models.CharField(max_length=50, blank=True, null=True)  # e.g. "North", "East"
    block_name = models.CharField(max_length=50, blank=True, null=True)  # e.g. "Block A"
